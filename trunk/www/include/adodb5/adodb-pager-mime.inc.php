...
class ADODB_Pager {
	...
	var $gridAttributes = 'width=100% border=0 bgcolor=#fff id=grid ';
	...
	function RenderLayout($header,$grid,$footer,$attributes='border=0 id=dashboard-body width=98%')
	{
